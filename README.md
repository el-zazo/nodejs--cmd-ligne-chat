...
- Colorful console output (via @el-zazo/console-messages)

## Installation

```bash
npm install @el-zazo/cmd-ligne-chat
```

## Basic Usage

```js
const { CmdLigneChat } = require("@el-zazo/cmd-ligne-chat");
...
```js
const { CmdLigneChat, validators } = require("@el-zazo/cmd-ligne-chat");
